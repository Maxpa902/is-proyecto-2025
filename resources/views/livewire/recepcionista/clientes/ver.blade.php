        ...
        <div class="form-body">
                    ...
                    <div class="info-section">
                        ...
                        <div class="info-grid">
                            ...
                            <div class="info-item">
                                ...
                                <span class="info-value">{{ $usuario->sexo_completo ?? 'No definido' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="info-section system-info">
                        ...
                        <div class="row">
                            ...
                            @if ($usuario->fecha_dado_baja)
                                <div class="col-md-6">
                                    <small class="text-muted">
                                        <strong>Dado de Baja:</strong>
                                        {{ $usuario->fecha_dado_baja->format('d/m/Y H:i') }}
                                    </small>
                                </div>
                            @endif
                        </div>
            ...
            <div class="form-footer">
                <div class="d-flex justify-content-between">
                    <x-boton variante="terciario" ruta="clientes.mostrar">
                    ...
                    @if ($usuario->estaActivo())
                    <x-boton tipo="submit" variante="primario" tamanio="mediano" ruta="clientes.editar" :parametros="[$usuario->id]" >
